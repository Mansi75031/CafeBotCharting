...
ul.cb-chart-css li a{
	/*color: #d8d9da;*/
	    color: hsla(0deg 0% 100% / 43%) !important;
}
ul.cb-chart-css li a.nav-link:hover{
	color: #fff;
}
ul.cb-chart-css li a.active {
    color: #fff !important;
}
.cb-chart-width{
	max-width: 35px;
...
ul.cb-chart-css li.nav-item {
    border-bottom: 1px solid rgba(204, 204, 220, 0.15);
    padding: 8px;
    /* margin: 0px; */
}
ul.cb-nav-block, ul.cb-chart-css {
    flex-direction: column;
}
/*new popup chart css end*/
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-2">
				...
				<div class=""><h5 class="text-uppercase">Dimensions &nbsp;&nbsp;
					<span class="cb-cursor" onclick="openDataset()"><i class="fa fa-database" aria-hidden="true"></i></span> &nbsp;&nbsp;

					<span id="menu-toggle" class="cb-cursor"><i class="fa fa-bar-chart" aria-hidden="true"></i></span>&nbsp;&nbsp; 

					<span class="cb-cursor" id="btnSave" onclick="openModal()"><i class="fa fa-plus" aria-hidden="true"></i></span>
					...
					<div class="col-sm-12" style="background-color:;">
						<div id="wrapper" class="toggled">
							<div id="sidebar-wrapper">
								...
								<div id="selectChartdiv"  style="position: relative;">
									<div class="cb-select-chart">
										<div class="row">
											<div class="col-3">
												<div class="cb-bar-chart-height">
													<ul  class="nav cb-chart-css" role="tablist">
														<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tab_chartcard1"><img class="cb-chart-width" src="<c:url value="/resources/chart_icon/bar_chart.png"/>"> Bar Chart</a></li>
														<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_chartcard2"><img class="cb-chart-width"  src="<c:url value="/resources/chart_icon/treemap.png"/>"> Table</a></li>
														<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_chartcard3"><img class="cb-chart-width"  src="<c:url value="/resources/chart_icon/scatter_line.png"/>"> Scatter</a></li>
														<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_chartcard4"><img class="cb-chart-width"  src="<c:url value="/resources/chart_icon/globe.png"/>"> Maps</a></li>
														<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab_chartcard5"><img class="cb-chart-width"  src="<c:url value="/resources/chart_icon/box_plot.png"/>"> Other</a></li>
											...
											<div class="col">
												<div class="tab-content cb-tab-chart-content">
													<div class="cb-close-tab cb-cursor" onclick="closetab()" style="position: absolute;
    right: 9px;">
														...
														<div class="row">
															<div class="col-12">
																...
																<div class="cb-chart-list-div">
																	<div class="cb-chart-content-div" id="chartcard1">
																		<img src="<c:url value="/resources/chart_icon/bar_chart.png"/>" >
																		<div class="cb-chart-title">
																			Histogram
																		</div>
																	</div>
																	<div class="cb-chart-content-div" id="chartcard2">
																		<img src="<c:url value="/resources/chart_icon/bar_chart.png"/>" >
																		<div class="cb-chart-title">
																			Bars
																		</div>
																	</div>
																	<div class="cb-chart-content-div" id="chartcard3">
																		<img src="<c:url value="/resources/chart_icon/stacked.png"/>" >
																		<div class="cb-chart-title">
																			Stacked
																		</div>
																	</div>
																	<!-- <div class="cb-chart-content-div">
																		<img src="<c:url value="/resources/chart_icon/bar_chart.png"/>" >
																		<div class="cb-chart-title">
																			Bars 100%
																		</div>
															...
															<div class="col-12">
																...
																<div class="row">
																	<div class="cb-chart-content-div" id="chartcard5">
																		<img src="<c:url value="/resources/chart_icon/line_chart.png"/>">
																		<div class="cb-chart-title">
																			Lines
																		</div>
																	</div>
																	<div class="cb-chart-content-div" id="chartcard4">
											...
											<nav id="navigation">
												<ul class="nav cb-nav-block" role="tablist" id="select_nav">  
													 <li class="nav-item  cb-chart-tab" onclick="barchartSelect()">
														<a class="nav-link cb-inner-icon" data-toggle="tab" href="#"><div class="cb-chart-selection"><i class="fa fa-caret-down" aria-hidden="true"></i><img src="chart icon/bar_chart.png"></div></a>
													</li> 
													<li class="nav-item  cb-chart-tab" id="add_border" >
														<a class="nav-link active" data-toggle="tab" href="#tab_chartcard1"><div class="cb-chart-selection"><img  src="chart icon/bar_chart.png"></div></a>
													</li>  
													<li class="nav-item  cb-chart-tab" id="add_border1">
														<a class="nav-link " data-toggle="tab" href="#tab_chartcard2"><div class="cb-chart-selection"><img  src="chart icon/bar_chart.png"></div></a>
													</li>
													<li class="nav-item  cb-chart-tab" id="add_border2">
														<a class="nav-link " data-toggle="tab" href="#tab_chartcard3"><div class="cb-chart-selection"><img  src="chart icon/bar_chart.png"></div></a>
													</li>
													<li class="nav-item  cb-chart-tab" id="add_border3">
														<a class="nav-link " data-toggle="tab" href="#tab_chartcard4"><div class="cb-chart-selection"><img src="chart icon/bar_chart.png"></div></a>
													</li>
													<li class="nav-item  cb-chart-tab" id="add_border4">
														<a class="nav-link " data-toggle="tab" href="#tab_chartcard5"><div class="cb-chart-selection"><img src="chart icon/bar_chart.png"></div></a>
													</li>
												</ul>
											</nav>   
											<div class="tab-content cb-tab-chart-content">
															...
															<div class="col-6">
																...
																<div class="cb-chart-list-div">
																	<div class="cb-chart-list" id="chartcard1">
																		<img src="chart icon/bar_chart.png">
				...
				+ "</span><span class=\"DataMapping_dimension-required__1FreW text-right\" style=\"opacity: 1;\">";
				 ...
				 if (!placetype.includes(coltype)) 
					...
					if (placeagg.includes("true")) {
						...
						var _agg = $("<ul class='list-unstyled cb-custom-dropdown'><li onclick='openDropCart()'><i class='fa fa-caret-down' aria-hidden='true'></i> Account Length </li></ul><div class='dropdown-cart' id='opencart' style='display: none;' ><div class='cb-cursor' onclick='closeDropCart()' style='float: right;right: 11px;position: absolute;top: 4px;'><i class='fa fa-times' aria-hidden='true'></i></div><div ><div class='cb-range-form-div'><div class='cb-range-Label'><span class='label'><div class='cb-range-text'>Binning</div></span><div><div class='cb-input-css'><select class='form-control' ><option value='sum'>Sum</option><option value='count'>Count</option><option value='uniq'>Count unique</option><option value='avg'>Avg</option><option value='max'>Max</option><option value='min'>Min</option><option value='medianTDigest'>Median</option></select></div></div></div></div></div>");
...
$("#btnSave").click(function(e) {
	...
	var listofdimsfilter = $('div.dropzoneselect');
					...
					var tablename = $("#tablelistData").val();
			    		...
			    		for(let i = 0; i < queryArr.length; i++){
			    			...
			    			if (queryArr[i][0].Datatype == 'text'){
			    				...
			    				if(queryArr[i][0].Agg!=''){
			    					...
			    					+"<li onclick='openDropCart()'><i class='fa fa-caret-down' aria-hidden='true'></i> Account Length</li></ul>"
			    					+"<div class='dropdown-cart' id='opencart' style='display: none;'><div class='cb-cursor' onclick='closeDropCart()'' style='float: right;right: 11px;position: absolute;top: 4px;'><i class='fa fa-times' aria-hidden='true'></i></div><div >"
			    					+"<div class='cb-range-form-div'>"
			    					+"<div class='cb-range-Label'>"
			    					+"<span class='label'><div class='cb-range-text'>Binning</div></span>"
			    					+"<div>"
			    					+"<div class='cb-input-css'>"
...
/*         $("#chkDeploy"+index).click(function () 
 ...
 function openDropCart() {
	//alert("gg");
	$("#opencart").fadeToggle( "fast");
}
function closeDropCart(){
	//alert("hide");
	$("#opencart").hide();
}
