  ...
  <div class="slide-in-content">
	...
	<div class="col-2">
			...
			<div class="cb-project-width">
				...
				<span class="cb-cursor me-2 project-icon-font-size"  onclick="openModal()" class="btn btn-primary" data-bs-toggle="tooltip" title="Save Chart"><i class="fa fa-floppy-o" aria-hidden="true"></i></span>
				
				
								
				<span class="cb-cursor me-2 project-icon-font-size"  onclick="opennewChartwindow()" class="btn btn-primary" data-bs-toggle="tooltip" title="Add Chart"><i class="fa fa-plus" aria-hidden="true"></i></span>
				
 
				<span class="cb-cursor project-icon-font-size"  onclick="gotohome()" class="btn btn-primary" 
		  ...
		  //console.log("globalTheme toggleTheme :::::::::::"+globalTheme);
		      ...
		      //  alert("lighttheme_chart");
		        ...
		        //document.getElementById("dark_").disabled = false;
		        			...
		        			$("#dark_").attr('href', '<c:url value="/resources/css/dark-unica.css"/>')
							...
							$("#theme_").attr('href', '<c:url value="/resources/css/chart_light.css"/>');
					...
					//	alert("darktheme_chart");
						...
						$("#dark_").attr('href', '<c:url value="/resources/css/dark-unica-dash.css"/>');
						$("#theme_").removeAttr('href', '<c:url value="/resources/css/chart_light.css"/>');
			...
			var chart_id =0;
	    				...
	    				if (_id == arr[k].id)	
		    			{
	    				 ...
	    				 $("#dataobjectname").html(dsname) ; 
	    					...
	    					var table_loadchart1 ="PT84430568S";
	    						//globalselectedtabnlename;
...
function selectBasicFilter_set(index, basicFilter_ ,tablename_)
{
	...
	$.ajax({method : "POST",					
		url : "/CafeBotCharting/selectbasicfilter",
		data : {
			field : Field_Basic,
