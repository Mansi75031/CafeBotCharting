...
////----------Switch between Dark and Light Theme  
 ...
 ////------------ Load Dashboard After Save Chart
  ...
  function AjaxChart(varDim,_charttype,_table,_containerID,varDimFilter,chartid,tabid ,themeAjaxChart){
	  ...
	  $.ajax({method : "POST", url : "/cafe-bot/menu/getchartDash",
			data : {
				chartName : "type",
				fieldsprop : varDim,
 ...
 ////---------------------Save Dashboard
      ...
      function saveDash() 
      {
  	   ...
  	   //console.log("theme::::::::::::::::"+theme);
  	    ...
  	    $.ajax({method : "POST", url : "/cafe-bot/menu/savedashboard",
  			data : {
  				dashid : dashid,
 ...
 /////-------------------Apply Filter To the Tab     
      ...
      function applyFilterbyid()
      {
 		...
 		//console.log("strRRR::::::",strRRR);
  				...
  				$.ajax({
  					method : "POST",			
  					url : "/cafe-bot/menu/applyDashboardFilterbyid",
  					data : {
     ...
     $(document).ready(function() {
     	...
     	try {
      		   ...
      		   {
 		     			  window.dispatchEvent(new Event('resize'));
 		  		    	console.log('MutationObserver size changed!###############');
     ...
     function outputsize() {
     	...
     	function loadchart1(chartid ,_containerID ,_table){
     		...
     		return new Promise((resolve) => {
     			...
     			$.ajax({method : "POST",	
     				async: false,
     				url : "/cafe-bot/menu/setchartDash",
     				data : {
     					id : chartid,
     					dashID:_id,
     				},
 ...
 var globalFilterCount_edit=0
     	function loadchartFilterbyidedit(chartid,varDimFilter){
     		...
     		return new Promise((resolve) => {
     			...
     			$.ajax({method : "POST",	
     				async: false,
     				url : "/cafe-bot/menu/setchartDashbyidedit",
     				data : {
     					id : chartid,
     					dashID : _id,
...
// 	alert("_id:loadchartFilterbyid:::"+chartid);
 	...
 	return new Promise((resolve) => {
 		...
 		$.ajax({method : "POST",	
 			async: false,
 			url : "/cafe-bot/menu/setchartDashbyid",
 			data : {
 				id : chartid,
 				dashID:_id,
 ...
 function tabdelete(index)
 {
 	...
 	var addTab_Flag =1;
 	 ...
 	 function selectCheckbox(basicFilter_){
 	   ...
 	   function selectBasicFilter_set(index,Field_Basic, basicFilter_ ,_table,set_userlimitBasic){
    ...
    function closeChartlist() 
    {
     ...
     function updateChartname(index,name)
     {
     	...
     	$.ajax({method : "POST",	
 			async: false,
 			url : "/cafe-bot/menu/updatechartname",
 			data : {
 				chartid : index,
 				chartname:name,
 			},
     ...
     function createNewDashboard()
     {
 		  var dashid =0;
 		  var projectid =0;
 		  $.ajax({method : "POST", url : "/cafe-bot/menu/savenewdashboard",
 				data : {
 				    dashid:dashid,
 				    projectid:0,
 				    isrealtime:0,
 				...
 				//----mansi
 					window.open('/cafe-bot/menu/visualanalytics_dashboard?id='+result,'_blank' );
